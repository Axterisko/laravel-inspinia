...
<head>
    ...
    <meta name="author" content="Axterisko Informatica Srl">
...
<div class="axt-sheet-holder">
    <div class="axt-sheet-overlay"></div>
    <div class="axt-sheet"></div>
</div>
@section('scripts')
    <script src="{{ mix('/js/manifest.js') }}" charset="utf-8"></script>
    <script src="{{ mix('/js/vendor.js') }}" charset="utf-8"></script>
    <script src="{{ mix('/js/messages.js') }}" charset="utf-8"></script>
    <script> Lang.setLocale('{!! App::getLocale() !!}'); </script>
    <script src="{{ mix('/js/inspinia.js') }}" charset="utf-8"></script>
    <script src="{!! asset('vendor/datatables/buttons.server-side.js') !!}" charset="utf-8"></script>
@show
@stack('body')
